                ...
                {languages.map((lang) => {
                    ...
                    return (
                        <button
                            ...
                            className={`py-2 px-2.5 text-xs font-semibold rounded-xl transition-all flex items-center justify-between gap-1.5 ${
                                isActive
                        ...
                        >
                            ...
                            {lang.script && (
                                <span className={`text-[10px] px-1.5 py-0.5 rounded-md ${
                                    isActive ? 'bg-white/20 text-[#02C39A]' : 'bg-zinc-200/60 text-zinc-500'
                                }`}>
                                    {lang.script}
                                </span>
                            )}
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        {lang.script && (
                                            <span className={`text-[10px] px-1.5 py-0.5 rounded ${
                                                isActive ? 'bg-[#028090]/15 text-[#028090]' : 'bg-zinc-100 text-zinc-500'
                                            }`}>
                                                {lang.script}
                                            </span>
                                        )}
