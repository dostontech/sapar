        ...
        <section id="pricing" className="w-full py-10 md:py-16 px-4 max-w-7xl mx-auto">
            ...
            <div className="text-center max-w-3xl mx-auto">
                ...
                <p className="text-sm sm:text-base md:text-lg text-slate-600 mt-3 leading-relaxed">
                    Barcha rejalar barcha 8 modulni o&apos;z ichiga oladi. Narxlar yakunlangunga qadar taxminiy.
                </p>

                {/* Billing Toggle (Oylik / Yillik) */}
            ...
            >
                {plans.map((plan, index) => {
                    ...
                    const isCustom = price === 'Individual narx';
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="mt-8 pt-6">
                                <a
                                    href="#contact"
                                    className={`w-full inline-flex items-center justify-center py-3.5 px-6 rounded-xl font-bold text-sm transition-all duration-200 ${
                                        isPopular
            ...
            <div className="mt-8 sm:mt-12 text-center text-xs text-slate-500">
                * Narxlar rasmiy ishga tushirishdan oldin e&apos;lon qilinadigan namunaviy hisob-kitoblar asosida keltirilgan.
            </div>
        </section>
    );
}
